...
public:
	...
	ASTNodeRegistry();
	explicit ASTNodeRegistry(std::vector<std::string> const& _labels, std::vector<size_t> const& _nameToLabelMapping);
...
public:
	...
	explicit ASTNodeRegistryBuilder(ASTNodeRegistry const& _existingLabels);
